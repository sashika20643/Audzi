  ...
  @include('components.header')
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Best way to listen songs</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">1K+ songs <span>1K+ songs</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Create an account <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url({{asset ('assets/images/bg001.jpg') }});"></div>
                <!-- Slide Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Enjoy your freedom</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">Free <span>Free</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Create an account <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
